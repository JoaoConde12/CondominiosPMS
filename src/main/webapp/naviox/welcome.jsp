...
En CondominiosPMS-labels_es.properties:
CondominiosPMS=Tu aplicación
CondominiosPMS[description]=Tu aplicación hace esto y lo otro

En CondominiosPMS-messages_en.properties:
