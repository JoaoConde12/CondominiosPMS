...
- Crea la clase de la acción en el paquete `com.condominiospms.CondominiosPMS.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="com.condominiospms.CondominiosPMS.acciones.MostrarImporte"/>
</controlador>
```
...
- ✅ Coloca las clases de acción en `com.condominiospms.CondominiosPMS.acciones`
...
```java
package com.condominiospms.CondominiosPMS.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `com.condominiospms.CondominiosPMS.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
